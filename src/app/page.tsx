  ...
  const tools: Tool[] = [
    {
      ...
      description:
        'Создавайте профессиональные объявления формата A4 с идеальным качеством печати. Поддержка всех ориентаций.',
    ...
    },
    {
      ...
      description:
        'Конструктор вертикальных визиток 55×85 мм. Оптимизированный макет 3×3 для ручной резки.',
